...
public class RuleTests
{
    ...
    {
        var threes = new TopRule(new RuleId(""), new DieRoll(3));
    ...
    {
        var straight = new StraightRule(new RuleId(""), 4, 30);
    ...
    {
        var same4 = new SameRule(new RuleId(""), 4);
    ...
    {
        var fullHouse = new FullHouseRule(new RuleId(""));
    ...
    {
        var yahtzee = new YahtzeeRule(new RuleId(""));
